...
mongoose.connect('mongodb+srv://rahulsinghnirban007:neymar07@cluster0.sp7oz.mongodb.net/myFirstDatabase?retryWrites=true&w=majority')
.then(()=>{
...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid='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';
  ...
  const msg={
      to: email,
      from: "rahulsinghnirban007@gmail.com",
